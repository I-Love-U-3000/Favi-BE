...
internal sealed class UploadAvatarCommandHandler : IRequestHandler<UploadAvatarCommand, SavedImageResult>
{
    private readonly IAuthWriteRepository _repo;

    public UploadAvatarCommandHandler(IAuthWriteRepository repo) => _repo = repo;

    public async Task<SavedImageResult> Handle(UploadAvatarCommand request, CancellationToken cancellationToken)
    {
