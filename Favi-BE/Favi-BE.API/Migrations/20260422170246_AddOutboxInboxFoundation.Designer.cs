...
namespace Favi_BE.Migrations
{
    ...
    [Migration("20260422170246_AddOutboxInboxFoundation")]
    partial class AddOutboxInboxFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Favi_BE.API.Models.Entities.JoinTables.MessageRead", b =>
                {
            ...
            modelBuilder.Entity("Favi_BE.BuildingBlocks.Infrastructure.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status", "ReceivedOnUtc");

                    b.ToTable("InboxMessages");
                });

            modelBuilder.Entity("Favi_BE.BuildingBlocks.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.EmailAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.JoinTables.StoryView", b =>
                {
                    ...
                    b.HasKey("StoryId", "ViewerProfileId");
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime?>("DeletedDayExpiredAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.Story", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Favi_BE.API.Models.Entities.JoinTables.MessageRead", b =>
                {
                    b.HasOne("Favi_BE.API.Models.Entities.Message", "Message")
                        .WithMany("ReadBy")
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.EmailAccount", b =>
                {
                    b.HasOne("Favi_BE.Models.Entities.Profile", "Profile")
                        .WithOne()
                        .HasForeignKey("Favi_BE.Models.Entities.EmailAccount", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.JoinTables.Reaction", b =>
                {
                    ...
                    b.HasOne("Favi_BE.Models.Entities.Comment", "Comment")
                        .WithMany("Reactions")
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.JoinTables.StoryView", b =>
                {
                    b.HasOne("Favi_BE.Models.Entities.Story", "Story")
                        .WithMany("StoryViews")
                        .HasForeignKey("StoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Favi_BE.Models.Entities.Profile", "Viewer")
                        .WithMany()
            ...
            modelBuilder.Entity("Favi_BE.Models.Entities.Notification", b =>
                {
                    b.HasOne("Favi_BE.Models.Entities.Profile", "Actor")
                        .WithMany()
                        .HasForeignKey("ActorProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Favi_BE.Models.Entities.Profile", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Favi_BE.Models.Entities.Comment", "TargetComment")
                        .WithMany()
                        .HasForeignKey("TargetCommentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Favi_BE.Models.Entities.Post", "TargetPost")
                        .WithMany()
