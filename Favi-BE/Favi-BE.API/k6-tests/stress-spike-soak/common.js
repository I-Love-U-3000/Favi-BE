// Shared helpers for stress, spike, and soak k6 scenarios.
// Loads deterministic seed data and exposes auth/login utilities.
...
export function pickPostId() {
  return seedPosts[(__VU + __ITER) % seedPosts.length].post_id;
}

export function getPowerUserProfileIds(limit = 30) {
